...
async function build(bengularJson) {
    ...
    allTasks.push({
        ...
        fn: async function (buildOptions) {
            return myFunctions.eslint(buildOptions, spawnSync, bengularJson);
        }
    });
    ...
    allTasks.push({
        ...
        fn: async function (buildOptions) {
            const scssFiles = myFunctions.getFiles(bengularJson.generatedDirectory, "scss");
    ...
    allTasks.push({
        ...
        fn: async function (buildOptions) {
            ...
            const generatedDirectory = bengularJson.generatedDirectory + "page-loads/";
        ...
        fn: async function (buildOptions) {
            ...
            let sassResult = spawnSync(
                ...
                ["node_modules/sass/sass.js",
                    bengularJson.srcDirectory + ":" + bengularJson.generatedDirectory + "scss/",
                    "--style=compressed",
                    "--no-source-map"],
                {
                    encoding: "utf8",
    ...
    allTasks.push({
        ...
        fn: async function (buildOptions) {
            ...
            for (let i = 0; i < assetsFiles.length; i++) {
                ...
                fs.copyFileSync(assetFile.path, assetFile.path.replace(bengularJson.srcDirectory, bengularJson.prodDirectory));
            }
            return 0;
        }
    });
