    ...
    allTasks.push({
        ...
        fn: async function (buildOptions) {
            ...
            if (tscResult.status !== 0) {
                ...
                myFunctions.log(tscResult.stdout);
                return 1;
            }
            return 0;
        }
        ...
        fn: async function (buildOptions) {
            ...
            for (let i = 0; i < jsFiles.length; i++) {
                ...
                if (result.error != null) {
                    myFunctions.log(`Error on bundle ${docFilePath}`);
                    myFunctions.log(result.error);
                    return 1;
                }
