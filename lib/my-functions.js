...
module.exports = {
    ...
    bundle: async function (name, entryDir, outDir, shared, bengularOptions) {
        //Helper function
        ...
        let b = browserify();
        b.add(bengularOptions.generatedDirectory + "tsc-dist/pages/" + entryDir + name + ".js");
        for (const sharedJs of shared) {
            b.exclude(bengularOptions.generatedDirectory + "tsc-dist/shared/" + sharedJs.entryDir + sharedJs.name + ".js");
        }
    ...
    eslint: function (buildOptions, spawnSync, bengularOptions) {
        ...
        if (eslintResult.status !== 0) {
            ...
            this.log(eslintResult.stdout, colors.red);
            return 1;
        }
        return 0;
    },
